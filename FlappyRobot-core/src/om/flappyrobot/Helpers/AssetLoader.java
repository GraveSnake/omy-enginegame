...
public class AssetLoader {
	...
	public static TextureRegion logo, gameLogo, bg, grass, engine_1, engine_2,
	...
	public static void load() {
		...
		engineAnimation.setPlayMode(Animation.PlayMode.LOOP);
		...
		prefs = Gdx.app.getPreferences("FlappyEngine");
